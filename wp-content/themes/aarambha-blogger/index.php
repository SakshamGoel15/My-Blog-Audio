    ...
    <div class="section-wrap section-padding">
        <div class="container">
            <div class="section-wrap-inner">
                ...
                <div class="section-left<?php if ( get_theme_mod('general_sidebar_home_checkbox','') != true ) { echo ' section-full-width';} ?>">
                    <section class="blog-section <?php if (get_theme_mod('blog_post_layout_radio_button','single') == 'grid') echo esc_attr('layout-grid')?> ">
                        ...
                        <?php
                        $blog_aarambha_arg = [
                            'screen_reader_text' => esc_html__( 'Post navigation','aarambha-blogger' ),
                            'prev_text'          =>  '',
                            'next_text'          =>  '',
                        ];
                        if (get_theme_mod('blog_paginate_radio_button','post_pagination') == 'post_pagination'):
                            ...
                            the_posts_navigation(['screen_reader_text' => esc_html__( 'Post navigation','aarambha-blogger' )]);
                        endif;
                        ?>
                    </section>
                ...
                <?php
                if ( get_theme_mod('general_sidebar_home_checkbox','') == true ) {
                    get_sidebar('home');
                }
                ?>
            </div>
